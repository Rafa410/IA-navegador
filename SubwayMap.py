...
class Map:
    ...
    self.connections: is a dictionary of dictionary holding all the connection information with the format of
            {
                station_1: {
                    first_connection_to_station_1: cost_1_1, 
                    second_connection_to_station_1: cost_1_2
                }
                station_2: {
                    first_connection_to_station_2: cost_2_1, 
                    second_connection_to_station_2: cost_2_2
                }
                ...
            }
    self.velocity: is a dictionary with the information about velocity for all lines
        {
            line_id1: velocity_value, 
            line_id2: velocity_value, 
            ...
        }
    """
    def __init__(self):
